...
function experienceCtrl ($scope) {
    $scope.experiences = [
        ...
        {
            dateRange: 'Apr 2019 - Jan 2020',
            position: 'Software Engineer -> S-CONSULTING',
            state: '',
            role: 'Keen on Java, JS, Spring Boot/MVC, REST , RDBMS, MongoDB, Docker, AWS.',
            href: ''
        },
        {
            ...
            position: 'Software Engineer -> USEL',
            state: '',
        ...
        },
        {
            ...
            position: 'Java Backend Developer -> BECOME JAVA SENIOR',
            state: '',
        ...
        },
        {
            ...
            position: 'Junior Web Developer -> SOFT SERVE INC',
            state: '',
