...
function experienceCtrl ($scope) {
    $scope.experiences = [
        {
            dateRange: 'Apr 2019 - today',
            position: 'Self-Employed on S-CONSULTING',
            state: '',
        ...
        },
        {
            ...
            position: 'Software Engineer on USEL',
            state: '',
        ...
        },
        {
            ...
            position: 'Java Backend Developer on BECOME JAVA SENIOR',
            state: '',
        ...
        },
        {
            ...
            position: 'Junior Web Developer on SOFT SERVE INC',
            state: '',
